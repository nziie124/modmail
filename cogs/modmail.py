...
class Modmail(commands.Cog):
    ...
    async def setup(self, ctx):
        ...
        embed.add_field(
            ...
            value="If you like what you see, consider giving Nziie "
            "a thanks :star: and if you are "
            "feeling extra generous, you can donate Nitro to `vNziie--` to say thx!",
        )
    ...
    async def joinstaff(self, ctx):
        ...
        embed = discord.Embed(
            description="<:wumpus_Police:822967656613281833> **Want to Apply For Staff? Read below!** <:wumpus_Police:822967656613281833>\n\n**Account Age/Applicant Age**\n`-` Accounts less than 50 days old will not be accepted.\n`-` Exceptions can be made on a case-to-case basis.\n`-` All applicants must be at least 14 years old.\n\n**Rules To Be Followed**\n`-` All applicants must be mature and have common sense.\n`-` All applicants must not have any previous kicks/bans or any other type of punishments except warns and mutes under 10 minutes within the last 30 days.\n`-` All applicants can not have been fired within the last 30 days.\n\n📋 - [Partnership Team Application](https://docs.google.com/forms/d/e/1FAIpQLSduciZsLdGbRtx3YKoDd6c52lyr15oXMH9RV8UIiH0mi5VeDw/viewform) `•` [Moderation Team Application](https://docs.google.com/forms/d/e/1FAIpQLSfrTKd2cMGW6n9SkbqrsTvBCApftORU_pT74a6ny0xtAJVv4g/viewform) `•` [Sales Team Application](https://docs.google.com/forms/d/e/1FAIpQLSdSeX28L-k5feGCr7QcJQTnRg3ly4nEOJCjGlB2Ug-jbdpIqg/viewform)\n\nYou will be DMed by  `Wumpus Assistant#8554` or `vNziie--#7777` if you were accepted! - Good luck!",
            color=discord.Colour.blue(),
        )
        embed.set_footer(text="Thanks for your interest in applying!")
        embed.set_author(name="Staff Applications", icon_url=ctx.guild.icon_url)
        return await ctx.send(embed=embed)
    ...
    async def inactivity(self, ctx, member: discord.Member):
        ...
        try:
            await member.send(embed=discord.Embed(description="What’s Up!\n\nThis is an automated message from the `WA Management Team`.\n\n*It has recently come to our attention that you have been a little inactive!* 💤 \n\nWe hope you are doing 👌 and staying safe. If you arent already in the staff server, please join it by clicking [here](https://discord.gg/n6Qz7BmHGa). There are going to be directions in <#821076577495416864> `[you will see after you pass Staff Training]` on how to fill out a break request correctly.\n\n*Cheers!*"
            ).set_footer(text="WA Management Team", icon_url=ctx.guild.icon_url))
            await ctx.send(f"**Notice sent to `{member.name}#{member.discriminator}`!**")
        except:
            await ctx.send("**Their dms are closed or they blocked the bot.**")
